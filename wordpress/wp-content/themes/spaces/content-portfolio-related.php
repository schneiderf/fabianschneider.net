...
<div class="row fadein more portfolio <?php if ($portfolio_layout == 'fullscreen' OR $portfolio_layout == 'carousel') { echo 'fullscreen'; }  if ($portfolio_layout == 'carousel') { echo ' crsl'; } if ($portfolio_content_display == 'off') { echo ' no-content'; } ?>">

     <ul id="portfolio-grid" class="more <?php if ($portfolio_layout == 'std') { echo 'std-layout'; } if ($portfolio_layout == 'fullscreen' OR $portfolio_layout == 'carousel') { echo 'fullscreen'; } ?> <?php echo get_theme_mod( 'portfolio_column_width');?>">
