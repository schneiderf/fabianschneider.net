...
<div class="portfolio-wrap social">
	...
	<ul class="portfolio-social">
		...
		<li><a href="http://pinterest.com/pin/create/bookmarklet/?media=<?php echo $feat_image; ?>&url=<?php the_permalink(); ?>&is_video=false&description=<?php the_title(); ?>" target="_blank" class="pinterest"><i class="fa fa-pinterest-square"></i><?php _e( 'Pin', 'bean' ); ?></a></li>
		<li><a href="https://plus.google.com/share?url=<?php the_permalink(); ?>" target="_blank" class="google even"><i class="fa fa-google-plus-square"></i><?php _e( 'Send', 'bean' ); ?></a></li>
