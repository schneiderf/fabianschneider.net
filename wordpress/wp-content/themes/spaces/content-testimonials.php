...
<ul class="avatar-list">
	...
	if ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) { ?>
		<li><a href="#testimonial-<?php the_ID(); ?>" class="testimonial-img <?php echo $class; echo $first; echo $mobile900; echo $mobile768; echo $mobile400;?>"><?php the_post_thumbnail('testimonial-feat'); ?><span class="testimonial-icon"></span></a></li>
	<?php }
...
<ul class="testimonial-list">
	...
	if ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) { ?>
		<li id="testimonial-<?php the_ID(); ?>" class="testimonial <?php echo $class; ?>">
			<h1><?php the_content(); ?></h1>
			<span class="subtext"><?php the_title(); ?></span>
		</li>	
	<?php }

	$count++; endwhile; endif; wp_reset_query(); ?>
