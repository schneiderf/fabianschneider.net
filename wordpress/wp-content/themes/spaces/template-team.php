...
if (is_plugin_active('bean-team-members/bean-team.php')) { ?>
...
<?php } else { //IF IT'S NOT, SHOW THIS NOTIFICATION ?>
	...
	<?php if ( is_user_logged_in() ) { ?>
		...
		<p class="text-centered"><?php _e( 'It looks like you have not installed or activated the Bean Team Members plugin.', 'bean' ); ?></p>
