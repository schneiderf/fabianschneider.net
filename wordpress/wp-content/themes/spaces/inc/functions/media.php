...
if ( !function_exists( 'bean_gallery' ) )
{
	function bean_gallery($postid, $imagesize = '', $layout = '', $orderby = '', $single = false )
	{
	    ...
	    if( $layout == 'stacked' )
	     ...
	     { ?>
			<div id="slider-<?php echo $postid; ?>" class="home-slider fadein <?php if ($portfolio_content_display == 'off') { echo ' no-content'; }?>">
				...
				<script type="text/javascript">
					jQuery(document).ready(function($){
						$('#slider-<?php echo esc_js($postid); ?>').superslides({
							...
							pagination: <?php if ($pagination == 'on') { echo esc_js('true'); } else { echo esc_js('false'); } ?>,
							<?php if ($autoplay == 'on') { echo esc_js('play: '.$autoplay_time.' '); } ?>
						});
					});
				</script>
			...
			<ul class="home-slider-mobile <?php if ($portfolio_content_display == 'off') { echo ' no-content'; } if( $lightbox == ' portfolio-lightbox' ) { echo ' lb-layout'; } ?>">
		...
		<?php
	     ...
	     { ?>
			<div class="carousel-wrap fadein">
				...
				<div class="crsl-items" data-navigation="carousel-nav">
						...
						<?php	
				     	...
				     	{	
				     		foreach( $attachments as $attachment )
				     		{
								...
								<article class="crsl-item <?php if( $lightbox == 'portfolio-lightbox' ) { echo 'lb';}?>">
									<?php if( $lightbox == 'portfolio-lightbox' ) { ?>
					...
					<nav id="carousel-nav" class="crsl-nav">
						<a href="#" class="next"><?php _e( 'Next', 'bean' ); ?></a>
						<a href="#" class="previous"><?php _e( 'Previous', 'bean' ); ?></a>
			...
			<ul class="home-slider-mobile fadein <?php if ($portfolio_content_display == 'off') { echo ' no-content'; } if( $lightbox == ' portfolio-lightbox' ) { echo ' lb-layout'; } ?>">
	    ...
	    if( $layout == 'grid-gallery' )
	    {
		    	...
		    	{ 
					...
					<li class="item gallery-grid <?php if( $lightbox != 'portfolio-lightbox' ) { echo 'no-lb'; } else { echo 'lb'; } ?>">
						<div class="portfolio">
							<?php if( $lightbox == 'portfolio-lightbox' ) { ?>
