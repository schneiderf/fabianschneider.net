...
function bean_register_required_plugins() {
	...
	$plugins = array(
		array(
			'name'                  => 'Bean Team Members',
			'slug'                  => 'bean-team-members', //FOLDER NAME
			'source'                => get_stylesheet_directory() . '/inc/plugins/bean-team-members.zip',
		...
		array(
			'name'                  => 'Bean Testimonials',
			'slug'                  => 'bean-testimonials', //FOLDER NAME
			'source'                => get_stylesheet_directory() . '/inc/plugins/bean-testimonials.zip',
			'required'              => false, //RECCOMENDED - NOT REQUIRED
			'version'               => '',
			'force_activation'      => false,
			'force_deactivation'    => false,
	...
	$config = array(
		...
		'strings'           => array(
		'page_title'                                => __( 'Install Included ThemeBeans Plugins', 'bean' ),
		'menu_title'                                => __( 'Install Plugins', 'bean' ),
